...
- Comandos: `bunx vitest run src/test/wave3-refund-increment-behavior.test.ts` → 34/34; `bunx vitest run` → 570/570; `bunx tsgo --noEmit` → limpo; `bun run build` → OK.
