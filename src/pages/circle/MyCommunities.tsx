                ...
                <Card className="overflow-hidden border-border hover:border-primary/40 hover:shadow-md transition-all duration-200 h-full flex flex-col">
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    <div className="flex items-start gap-3">
                      {c.icon_url ? (
                        <img src={c.icon_url} alt="" className="h-10 w-10 rounded-xl object-cover shrink-0 -mt-8 ring-2 ring-background shadow" />
                      ) : (
                        <div className="h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center shrink-0 -mt-8 ring-2 ring-background shadow">
