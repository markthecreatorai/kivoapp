    ...
    <div className="p-4 space-y-4">
      ...
      <div className="bg-card rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="px-4 pt-4 pb-4 space-y-4">
          ...
          <button
            onClick={() => {
              navigator.clipboard.writeText(`${window.location.host}/circles/${community.slug}`);
          ...
          >
            ...
            <span className="truncate">{window.location.host}/circles/{community.slug}</span>
          </button>
        ...
        <DialogContent className="sm:max-w-md p-6">
          ...
          <div className="pt-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Button variant="outline" className="gap-2 text-sm h-10"
                onClick={() => {
                  navigator.clipboard.writeText(inviteLink).then(() => toast.success("Link copiado!"));
      ...
      <Dialog open={showInstagramSheet} onOpenChange={setShowInstagramSheet}>
        <DialogContent className="sm:max-w-sm p-6">
          ...
          <div className="pt-3 space-y-4">
            <p className="text-sm text-muted-foreground">
              Link copiado! Cole no seu <span className="font-medium text-foreground">story</span>, <span className="font-medium text-foreground">reel</span> ou <span className="font-medium text-foreground">bio</span>.
            </p>
            <div className="space-y-2">
              <Button className="w-full gap-2 font-semibold" onClick={() => {
              ...
              {typeof navigator !== "undefined" && "share" in navigator && (
                <Button variant="ghost" className="w-full gap-2 text-muted-foreground" onClick={() => {
                  navigator.share({ title: community.name, text: `Participe de ${community.name} na Kivo!`, url: inviteLink }).catch(() => {});
